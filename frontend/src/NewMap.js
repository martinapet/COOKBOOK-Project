...
class NewMap extends Component {
    ...
    fetchPlaces = () => {
        fetch(
            ...
            }&intent=browse&radius=10000&query=restaurant&client_id=HZ21RK3NNBTL3ZOGAMSHFJRNDL1ZBPLW5HYRZTA1KWEASQBK&client_secret=DAADMNE0DYR1O4YGFFPX005YUZSNUJD1AQCWVB1OHGVRNG5N&v=20180708`
        )
            .then(response => {
