  ...
  fetchImage = () => {
    ...
    fetch(
        `https://api.foursquare.com/v2/venues/${
            this.props.place.id
        }/photos?limit=1&client_id=IHC5PDBUCT0F3SI4YB3U3F42FOZVDJBADAWH4GYH2HMXVAJJ&client_secret=OAXRZ0JXR5YVJ45YGTV0GB5VY0N1A5BELCMIAWW33IORMQ50&v=20180803`
    )
        ...
        .then(data => {
          ...
          if(data.response.photos.items[0] === undefined || data.response.photos.items[0] === undefined) {
            prefix = "https://fastly.4sqi.net/img/general/";
            suffix = "/KHPDDYHVNXDUQL4PH4XKSC0H5GC0YJSXGWBEEASVU5GUPX33.jpg";
          }
          else {
